...
class cocktail_core_layout_formatter_InlineFormattingContext extends cocktail_core_layout_formatter_FormattingContext {
	...
	public function getRemainingLineWidth() {
		return $this->_formattingContextRoot->coreStyle->usedValues->width - $this->_formattingContextData->x - $this->_floatsManager->getRightFloatOffset($this->_formattingContextData->y + $this->_formattingContextRoot->get_bounds()->y, $this->_formattingContextRoot->coreStyle->usedValues->width);
	}
