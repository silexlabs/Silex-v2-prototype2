...
class php_Lib {
	...
	static function mail($to, $subject, $message, $additionalHeaders = null, $additionalParameters = null) {
		...
		if(null !== $additionalParameters) {
			$裨mp = mail($to, $subject, $message, $additionalHeaders, $additionalParameters);
			$GLOBALS['%s']->pop();
			return $裨mp;
		} else {
			if(null !== $additionalHeaders) {
				$裨mp = mail($to, $subject, $message, $additionalHeaders);
				$GLOBALS['%s']->pop();
				return $裨mp;
			} else {
				$裨mp = mail($to, $subject, $message);
				$GLOBALS['%s']->pop();
				return $裨mp;
			}
		}
