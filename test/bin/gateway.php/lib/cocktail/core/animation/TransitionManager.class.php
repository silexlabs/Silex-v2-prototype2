...
class cocktail_core_animation_TransitionManager {
	...
	public function startTransitionTimer() {
		$GLOBALS['%s']->push("cocktail.core.animation.TransitionManager::startTransitionTimer");
		$»spos = $GLOBALS['%s']->length;
	...
	public function startTransition($target, $propertyName, $startValue, $endValue, $transitionDuration, $transitionDelay, $transitionTimingFunction, $onComplete, $onUpdate, $invalidationReason) {
		...
		$»spos = $GLOBALS['%s']->length;
		$transition = new cocktail_core_animation_Transition($propertyName, $target, $transitionDuration, $transitionDelay, $transitionTimingFunction, $startValue, $endValue, $onComplete, $onUpdate, $invalidationReason);
