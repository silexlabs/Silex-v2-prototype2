...
class cocktail_core_renderer_BoxRenderer extends cocktail_core_renderer_InvalidatingElementRenderer {
	...
	public function getContainerBlockData() {
		...
		$製pos = $GLOBALS['%s']->length;
		{
			$裨mp = new cocktail_core_layout_ContainingBlockVO($this->coreStyle->usedValues->width, $this->coreStyle->isAuto($this->coreStyle->get_width()), $this->coreStyle->usedValues->height, $this->coreStyle->isAuto($this->coreStyle->get_height()));
			$GLOBALS['%s']->pop();
			return $裨mp;
		}
		$GLOBALS['%s']->pop();
	...
	public function isClear() {
		...
		$製pos = $GLOBALS['%s']->length;
		$裨 = ($this->coreStyle->getKeyword($this->coreStyle->get_clear()));
		switch($裨->index) {
		case 11:
		case 12:
		case 31:
	...
	public function isVisible() {
		...
		$製pos = $GLOBALS['%s']->length;
		{
			$裨mp = $this->coreStyle->getKeyword($this->coreStyle->get_visibility()) != cocktail_core_css_CSSKeywordValue::$HIDDEN;
			$GLOBALS['%s']->pop();
			return $裨mp;
		}
		$GLOBALS['%s']->pop();
	...
	public function isInlineLevel() {
		...
		$製pos = $GLOBALS['%s']->length;
		$ret = false;
		$裨 = ($this->coreStyle->getKeyword($this->coreStyle->get_display()));
		switch($裨->index) {
		case 30:
		case 29:
		{
	...
	public function isRelativePositioned() {
		...
		$製pos = $GLOBALS['%s']->length;
		{
			$裨mp = $this->coreStyle->getKeyword($this->coreStyle->get_position()) == cocktail_core_css_CSSKeywordValue::$RELATIVE;
			$GLOBALS['%s']->pop();
			return $裨mp;
		}
		$GLOBALS['%s']->pop();
	...
	public function isPositioned() {
		...
		$製pos = $GLOBALS['%s']->length;
		{
			$裨mp = $this->coreStyle->getKeyword($this->coreStyle->get_position()) != cocktail_core_css_CSSKeywordValue::$STATIC;
			$GLOBALS['%s']->pop();
			return $裨mp;
		}
		$GLOBALS['%s']->pop();
	...
	public function isFloat() {
		...
		$製pos = $GLOBALS['%s']->length;
		{
			$裨mp = $this->coreStyle->isNone($this->coreStyle->get_cssFloat()) === false;
			$GLOBALS['%s']->pop();
			return $裨mp;
		}
		$GLOBALS['%s']->pop();
