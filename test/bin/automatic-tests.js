...
$hxExpose(org.slplayer.core.Application, "automatic-tests");
...
org.slplayer.core.Application.prototype = {
	...
	,resolveCompClass: function(classname) {
		...
		if(componentClass == null) haxe.Log.trace("ERROR cannot resolve " + classname,{ fileName : "Application.hx", lineNumber : 499, className : "org.slplayer.core.Application", methodName : "resolveCompClass"});
	...
	,createNonUIComponents: function() {
		...
		while(_g < _g1.length) {
			...
			try {
				...
				haxe.Log.trace("ERROR while creating " + rc.classname + ": " + Std.string(unknown),{ fileName : "Application.hx", lineNumber : 461, className : "org.slplayer.core.Application", methodName : "createNonUIComponents"});
				var excptArr = haxe.Stack.exceptionStack();
				if(excptArr.length > 0) haxe.Log.trace(haxe.Stack.toString(haxe.Stack.exceptionStack()),{ fileName : "Application.hx", lineNumber : 465, className : "org.slplayer.core.Application", methodName : "createNonUIComponents"});
			}
	...
	,initUIComponents: function(compInstances) {
		...
		while( $it0.hasNext() ) {
			...
			try {
				...
				haxe.Log.trace("ERROR while trying to call init() on a " + Type.getClassName(Type.getClass(ci)) + ": " + Std.string(unknown),{ fileName : "Application.hx", lineNumber : 412, className : "org.slplayer.core.Application", methodName : "initUIComponents"});
				var excptArr = haxe.Stack.exceptionStack();
				if(excptArr.length > 0) haxe.Log.trace(haxe.Stack.toString(haxe.Stack.exceptionStack()),{ fileName : "Application.hx", lineNumber : 416, className : "org.slplayer.core.Application", methodName : "initUIComponents"});
			}
		}
	}
			...
			while(_g < _g1.length) {
				...
				while(_g2 < _g3.length) {
					...
					try {
						...
						haxe.Log.trace("ERROR while creating " + rc.classname + ": " + Std.string(unknown),{ fileName : "Application.hx", lineNumber : 362, className : "org.slplayer.core.Application", methodName : "createUIComponents"});
						var excptArr = haxe.Stack.exceptionStack();
						if(excptArr.length > 0) haxe.Log.trace(haxe.Stack.toString(haxe.Stack.exceptionStack()),{ fileName : "Application.hx", lineNumber : 366, className : "org.slplayer.core.Application", methodName : "createUIComponents"});
					}
...
publication.TestClient = function() {
	silex.ServiceBase.GATEWAY_URL = "./automatic-tests.php/";
...
publication.TestClient.prototype = {
	doRename: function() {
		haxe.Log.trace("doRename",{ fileName : "TestClient.hx", lineNumber : 234, className : "publication.TestClient", methodName : "doRename"});
		this.publicationService.rename("duplicated-tmp","renamed-tmp",this.createAsyncCallback("publication-data/" + "renamed-tmp/app.css","body{\n\tfont-family: Verdana, Arial;\n\tfont-size: 14pt;\n    margin: 0;\n    padding: 0;\n    background-color: grey;\n    overflow: auto;\n}"),$bind(this,this.onError));
		haxe.Log.trace("NOW REMOVE THE FOLDERS FROM PREVIOUS TEST: sudo rm -R test/bin/publication-data/write/*-tmp",{ fileName : "TestClient.hx", lineNumber : 239, className : "publication.TestClient", methodName : "doRename"});
	}
	,testDuplicateAndRename: function() {
		haxe.Log.trace("testDuplicateAndRename, REMEMBER TO DELETE FOLDERS FROM PREVIOUS TEST: sudo rm -R test/bin/publication-data/write/*-tmp",{ fileName : "TestClient.hx", lineNumber : 226, className : "publication.TestClient", methodName : "testDuplicateAndRename"});
		this.publicationService.duplicate("test-duplicate","duplicated-tmp",this.createAsyncCallback("publication-data/" + "duplicated-tmp/app.css","body{\n\tfont-family: Verdana, Arial;\n\tfont-size: 14pt;\n    margin: 0;\n    padding: 0;\n    background-color: grey;\n    overflow: auto;\n}"),$bind(this,this.onError));
		haxe.Timer.delay($bind(this,this.doRename),100);
	}
	,doEmptyTrash: function() {
		haxe.Log.trace("doEmptyTrash",{ fileName : "TestClient.hx", lineNumber : 217, className : "publication.TestClient", methodName : "doEmptyTrash"});
	...
	,doTrash: function() {
		haxe.Log.trace("doTrash",{ fileName : "TestClient.hx", lineNumber : 209, className : "publication.TestClient", methodName : "doTrash"});
		this.publicationService.trash("test-create-tmp",utest.Assert.createAsync($bind(this,this.onResultWriteNoCheck),4000),$bind(this,this.onError));
		haxe.Timer.delay($bind(this,this.doEmptyTrash),100);
	}
	,testCreateAndTrash: function() {
		haxe.Log.trace("testCreateAndTrash",{ fileName : "TestClient.hx", lineNumber : 201, className : "publication.TestClient", methodName : "testCreateAndTrash"});
		this.publicationService.create("test-create-tmp",{ html : "<HTML>\n\t<HEAD>\n\t</HEAD>\n\t<BODY>\n\t\tTest Publication\n\t</BODY>\n</HTML>", css : "body{\n\tfont-family: Verdana, Arial;\n\tfont-size: 14pt;\n    margin: 0;\n    padding: 0;\n    background-color: grey;\n    overflow: auto;\n}"},this.createAsyncCallback("publication-data/" + "test-create-tmp/app.css","body{\n\tfont-family: Verdana, Arial;\n\tfont-size: 14pt;\n    margin: 0;\n    padding: 0;\n    background-color: grey;\n    overflow: auto;\n}"),$bind(this,this.onError));
	...
	,testWrite: function() {
		this.publicationService.setPublicationData("test-write",{ html : "<HTML>\n\t<HEAD>\n\t</HEAD>\n\t<BODY>\n\t\tTest Publication\n\t</BODY>\n</HTML>", css : "body{\n\tfont-family: Verdana, Arial;\n\tfont-size: 14pt;\n    margin: 0;\n    padding: 0;\n    background-color: grey;\n    overflow: auto;\n}"},this.createAsyncCallback("publication-data/" + "test-write/app.css","body{\n\tfont-family: Verdana, Arial;\n\tfont-size: 14pt;\n    margin: 0;\n    padding: 0;\n    background-color: grey;\n    overflow: auto;\n}"),$bind(this,this.onError));
	}
	...
	,testGetThemes: function() {
		this.publicationService.getPublications(null,[silex.publication.PublicationCategory.Theme],utest.Assert.createEvent($bind(this,this.onResultGetThemes)));
	}
	...
	,testGetPublications: function() {
		this.publicationService.getPublications([silex.publication.PublicationState.Private],null,utest.Assert.createEvent($bind(this,this.onResultGetPublications)));
	}
	...
	,testRead: function() {
		this.publicationService.getPublicationData("test-publication-private",utest.Assert.createEvent($bind(this,this.onResultRead),2000),$bind(this,this.onError));
...
AllTestsClient.GATEWAY_URL = "./automatic-tests.php/";
