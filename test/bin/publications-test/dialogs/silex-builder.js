...
var dialogs = {}
dialogs.TestClient = function() {
};
$hxClasses["dialogs.TestClient"] = dialogs.TestClient;
dialogs.TestClient.__name__ = ["dialogs","TestClient"];
dialogs.TestClient.main = function() {
	haxe.Timer.delay(function() {
		return dialogs.TestClient.init();
	},1000);
	silex.ServiceBase.GATEWAY_URL = "../../gateway.php/";
}
dialogs.TestClient.init = function(unused) {
	var application = org.slplayer.core.Application.createApplication();
	application.initDom();
	haxe.Log.trace(" application.init ",{ fileName : "TestClient.hx", lineNumber : 52, className : "dialogs.TestClient", methodName : "init"});
	application.initComponents();
	haxe.Timer.delay(dialogs.TestClient.doAfterInit,1000);
}
dialogs.TestClient.doAfterInit = function() {
...
dialogs.TestClient.prototype = {
	__class__: dialogs.TestClient
}
var haxe = {}
