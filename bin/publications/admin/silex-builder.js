...
brix.component.interaction.NotificationManager.prototype = $extend(brix.component.ui.DisplayObject.prototype,{
	...
	,refreshNotifications: function() {
		haxe.Log.trace("refreshNotifications " + Std.string(this.notifications) + " - " + this.notificationTemplate,{ fileName : "NotificationManager.hx", lineNumber : 278, className : "brix.component.interaction.NotificationManager", methodName : "refreshNotifications"});
		...
		try {
			...
			haxe.Log.trace("Error: " + Std.string(e),{ fileName : "NotificationManager.hx", lineNumber : 286, className : "brix.component.interaction.NotificationManager", methodName : "refreshNotifications"});
		}
		haxe.Log.trace("refreshNotifications " + this.notificationZone.innerHTML,{ fileName : "NotificationManager.hx", lineNumber : 288, className : "brix.component.interaction.NotificationManager", methodName : "refreshNotifications"});
	}
	,sendCustomNotification: function(notification,duration) {
		if(duration == null) duration = 10000;
		haxe.Log.trace("sendCustomNotification " + Std.string(notification),{ fileName : "NotificationManager.hx", lineNumber : 265, className : "brix.component.interaction.NotificationManager", methodName : "sendCustomNotification"});
	...
	,sendNotification: function(e,duration) {
		if(duration == null) duration = 10000;
		haxe.Log.trace("sendNotification " + Std.string(e),{ fileName : "NotificationManager.hx", lineNumber : 229, className : "brix.component.interaction.NotificationManager", methodName : "sendNotification"});
		if(!this.hasNotification()) {
			haxe.Log.trace("NO NOTIFICATION SYSTEM",{ fileName : "NotificationManager.hx", lineNumber : 232, className : "brix.component.interaction.NotificationManager", methodName : "sendNotification"});
			throw "NO NOTIFICATION SYSTEM";
		}
		if(!this.hasPermission()) {
			haxe.Log.trace("NO NOTIFICATION PERMISSION",{ fileName : "NotificationManager.hx", lineNumber : 237, className : "brix.component.interaction.NotificationManager", methodName : "sendNotification"});
	...
	,requestPermission: function(acceptCallback,denyCallback) {
		haxe.Log.trace("requestPermission ",{ fileName : "NotificationManager.hx", lineNumber : 207, className : "brix.component.interaction.NotificationManager", methodName : "requestPermission"});
		if(this.hasNotification()) {
			if(this.hasPermission()) {
				haxe.Log.trace("PERMISSION ALLOWED",{ fileName : "NotificationManager.hx", lineNumber : 212, className : "brix.component.interaction.NotificationManager", methodName : "requestPermission"});
				acceptCallback();
			} else {
				haxe.Log.trace("PERMISSION ASKED",{ fileName : "NotificationManager.hx", lineNumber : 215, className : "brix.component.interaction.NotificationManager", methodName : "requestPermission"});
		...
		} else haxe.Log.trace("NO NOTIFICATION SYSTEM",{ fileName : "NotificationManager.hx", lineNumber : 221, className : "brix.component.interaction.NotificationManager", methodName : "requestPermission"});
	}
	,permissionRequestCallback: function(acceptCallback,denyCallback) {
		haxe.Log.trace("permissionRequestCallback " + Std.string(this.hasPermission()),{ fileName : "NotificationManager.hx", lineNumber : 190, className : "brix.component.interaction.NotificationManager", methodName : "permissionRequestCallback"});
...
brix.component.layout.Panel.prototype = $extend(brix.component.layout.LayoutBase.prototype,{
	...
	,init: function() {
		...
		if(this.header == null) haxe.Log.trace("Warning, no header for Panel component",{ fileName : "Panel.hx", lineNumber : 96, className : "brix.component.layout.Panel", methodName : "init"});
		...
		if(this.footer == null) haxe.Log.trace("Warning, no footer for Panel component",{ fileName : "Panel.hx", lineNumber : 108, className : "brix.component.layout.Panel", methodName : "init"});
...
silex.component.ComponentModel.prototype = $extend(silex.ModelBase.prototype,{
	...
	,makeLinkToPage: function(htmlDom,pageName) {
		...
		var linkToPage = new silex.ui.link.SilexLink(htmlDom,publicationModel.application.id);
		linkToPage.init();
	}
...
silex.interpreter.Interpreter.prototype = {
	execScriptTags: function(rootElement) {
		...
		haxe.Log.trace("execScriptTags " + Std.string(rootElement) + " - " + rootElement.className + " - " + scriptTags.length,{ fileName : "Interpreter.hx", lineNumber : 93, className : "silex.interpreter.Interpreter", methodName : "execScriptTags"});
	...
	,expose: function(key,obj) {
		haxe.Log.trace("expose " + key,{ fileName : "Interpreter.hx", lineNumber : 84, className : "silex.interpreter.Interpreter", methodName : "expose"});
...
silex.publication.PublicationModel = function() {
	...
	silex.interpreter.Interpreter.getInstance().expose("PublicationModel",silex.publication.PublicationModel);
};
...
silex.publication.PublicationModel.prototype = $extend(silex.ModelBase.prototype,{
	onSaveSuccess: function() {
		...
		haxe.Log.trace("PUBLICATION SAVED",{ fileName : "PublicationModel.hx", lineNumber : 648, className : "silex.publication.PublicationModel", methodName : "onSaveSuccess"});
	...
	,onDeleteSuccess: function() {
		haxe.Log.trace("PUBLICATION DELETED ",{ fileName : "PublicationModel.hx", lineNumber : 495, className : "silex.publication.PublicationModel", methodName : "onDeleteSuccess"});
		this.unload();
	}
	,trash: function(name) {
	...
	,initBrixApplication: function(rootElement) {
		...
		if(initialPageName != null) {
			...
			if(page != null) silex.page.PageModel.getInstance().setSelectedItem(page); else haxe.Log.trace("Warning: could not resolve default page name (" + initialPageName + ")",{ fileName : "PublicationModel.hx", lineNumber : 418, className : "silex.publication.PublicationModel", methodName : "initBrixApplication"});
		} else haxe.Log.trace("Warning: no initial page found",{ fileName : "PublicationModel.hx", lineNumber : 422, className : "silex.publication.PublicationModel", methodName : "initBrixApplication"});
		haxe.Log.trace("PublicationModel exec " + Std.string(rootElement) + " - " + rootElement.className,{ fileName : "PublicationModel.hx", lineNumber : 427, className : "silex.publication.PublicationModel", methodName : "initBrixApplication"});
	...
	,onData: function(publicationData) {
		...
		if(this.currentName != "") title = title + " (" + this.currentName + ")";
	...
	,load: function(name,configData) {
		...
		if(name == "") {
			haxe.Log.trace("unload",{ fileName : "PublicationModel.hx", lineNumber : 245, className : "silex.publication.PublicationModel", methodName : "load"});
	...
	,setPublicationName: function(newName) {
		this.currentName = newName;
		brix.util.DomTools.setBaseTag("../" + newName + "/");
		return newName;
	}
	,getModelFromView: function(viewHtmlDom) {
		if(viewHtmlDom == null) {
			haxe.Log.trace("Warning: could not retrieve the model for element because it is null.",{ fileName : "PublicationModel.hx", lineNumber : 176, className : "silex.publication.PublicationModel", methodName : "getModelFromView"});
			return null;
		}
		try {
			...
			haxe.Log.trace("Error, could not retrieve the model for element " + Std.string(viewHtmlDom) + " (" + Std.string(e) + ").",{ fileName : "PublicationModel.hx", lineNumber : 207, className : "silex.publication.PublicationModel", methodName : "getModelFromView"});
	...
	,__properties__: $extend(silex.ModelBase.prototype.__properties__,{set_currentName:"setPublicationName"})
});
...
silex.ui.dialog.FileBrowserDialog.selectMultipleFiles = function(userCallback,brixInstanceId,msg) {
...
silex.ui.dialog.FileBrowserDialog.selectFile = function(userCallback,brixInstanceId,msg) {
...
silex.ui.dialog.FileBrowserDialog.getRelativeURLFromFileBrowser = function(url) {
	...
	if(idx == -1) {
		...
		if(idxPubFolder >= 0) {
			...
			var pubUrl1 = silex.publication.PublicationModel.getInstance().currentName + "/";
			var idxPubFolder1 = url.indexOf(pubUrl1);
			if(idxPubFolder1 >= 0) url = HxOverrides.substr(url,idxPubFolder1 + pubUrl1.length,null); else url = "../" + url;
		}
...
silex.ui.dialog.FileBrowserDialog.prototype = $extend(silex.ui.dialog.DialogBase.prototype,{
	...
	,validateMultipleSelection: function(files) {
		haxe.Log.trace("validateMultipleSelection " + Std.string(files),{ fileName : "FileBrowserDialog.hx", lineNumber : 175, className : "silex.ui.dialog.FileBrowserDialog", methodName : "validateMultipleSelection"});
		if(files != null) {
...
silex.ui.dialog.TextEditorDialog.prototype = $extend(silex.ui.dialog.DialogBase.prototype,{
	...
	,requestRedraw: function(transitionData) {
		this.contentLoaded("<iframe name=\"kcfinder_iframe\" src=\"" + "../../third-party-tools/ckeditor/ckeditor.html" + "\"" + " frameborder=\"0\" width=\"100%\" marginwidth=\"0\" marginheight=\"0\" scrolling=\"no\" />");
	}
...
silex.ui.list.PageList.prototype = $extend(brix.component.list.List.prototype,{
	...
	,buildDataProvider: function() {
		var publicationModel = silex.publication.PublicationModel.getInstance();
		if(publicationModel.application != null) return this.dataProvider = silex.page.PageModel.getInstance().getClasses(publicationModel.viewHtmlDom,publicationModel.application.id,brix.component.navigation.Page);
		return new Array();
	}
	,reloadData: function() {
...
silex.ui.stage.InsertDropHandler.prototype = $extend(silex.ui.stage.DropHandlerBase.prototype,{
	...
	,onFileChosen: function(element,fileUrl) {
		haxe.Log.trace("onFileChosen " + fileUrl,{ fileName : "InsertDropHandler.hx", lineNumber : 191, className : "silex.ui.stage.InsertDropHandler", methodName : "onFileChosen"});
	...
	,initImageComp: function(element) {
		...
		silex.ui.dialog.FileBrowserDialog.selectFile(cbk,this.brixInstanceId);
	}
	,onMultipleFilesChosen: function(element,files) {
		haxe.Log.trace("onMultipleFilesChosen " + Std.string(files),{ fileName : "InsertDropHandler.hx", lineNumber : 161, className : "silex.ui.stage.InsertDropHandler", methodName : "onMultipleFilesChosen"});
		silex.property.PropertyModel.getInstance().setAttribute(element,"controls","controls");
		var modelHtmlDom = silex.publication.PublicationModel.getInstance().getModelFromView(element);
		var _g = 0;
...
silex.ui.toolbox.MenuController.createPublication = function() {
	silex.publication.PublicationModel.getInstance().create();
}
silex.ui.toolbox.MenuController.trashPublication = function() {
...
silex.ui.toolbox.MenuController.openPublication = function() {
	brix.component.navigation.Page.openPage("open-dialog",true,null,null,silex.ui.toolbox.MenuController.menuBrixId);
}
silex.ui.toolbox.MenuController.closePublication = function() {
	silex.publication.PublicationModel.getInstance().unload();
}
silex.ui.toolbox.MenuController.viewPublication = function() {
	js.Lib.window.open("../" + silex.publication.PublicationModel.getInstance().currentName,"_blank");
}
silex.ui.toolbox.MenuController.savePublication = function() {
...
silex.ui.toolbox.MenuController.savePublicationAs = function() {
...
silex.ui.toolbox.MenuController.savePublicationCopy = function() {
...
silex.ui.toolbox.MenuController.prototype = $extend(brix.component.ui.DisplayObject.prototype,{
	onClick: function(e) {
		...
		case "create-publication":
			silex.ui.toolbox.MenuController.createPublication();
			break;
		case "trash-publication":
			silex.ui.toolbox.MenuController.trashPublication();
			break;
		case "open-publication":
			silex.ui.toolbox.MenuController.openPublication();
			break;
		case "close-publication":
			silex.ui.toolbox.MenuController.closePublication();
			break;
		case "view-publication":
			silex.ui.toolbox.MenuController.viewPublication();
			break;
		case "save-publication":
			silex.ui.toolbox.MenuController.savePublication();
			break;
		case "save-publication-as":
			silex.ui.toolbox.MenuController.savePublicationAs();
			break;
		case "save-publication-copy":
			silex.ui.toolbox.MenuController.savePublicationCopy();
			break;
		case "add-page":
...
silex.ui.toolbox.ToolBoxController.prototype = $extend(brix.component.ui.DisplayObject.prototype,{
	redraw: function() {
		haxe.Log.trace("redraw ",{ fileName : "ToolBoxController.hx", lineNumber : 196, className : "silex.ui.toolbox.ToolBoxController", methodName : "redraw"});
		var innerHtml = "";
		var t;
		try {
	...
	,onLoadSuccess: function(xmlString) {
		...
		if(initialPage == null) haxe.Log.trace("Warning: the initialPage attribute is not set on the ToolBoxController node",{ fileName : "ToolBoxController.hx", lineNumber : 134, className : "silex.ui.toolbox.ToolBoxController", methodName : "onLoadSuccess"});
...
silex.ui.toolbox.editor.EditorBase.prototype = $extend(brix.component.ui.DisplayObject.prototype,{
	...
	,onPropertyChange: function(e) {
		...
		if(e.detail.name == this.propertyName) try {
			this.reset();
		} catch( e1 ) {
	...
	,init: function() {
		...
		if(this.groupElement == null) haxe.Log.trace("Warning: Editor found outside a property group.",{ fileName : "EditorBase.hx", lineNumber : 74, className : "silex.ui.toolbox.editor.EditorBase", methodName : "init"}); else {
			this.propertyName = this.groupElement.getAttribute("data-property-name");
			if(this.propertyName == null || this.propertyName == "") haxe.Log.trace("Could not find the property name for the editor. It was not set in the attribute \"data-property-name\" of the group node (" + this.groupElement.className + ").",{ fileName : "EditorBase.hx", lineNumber : 80, className : "silex.ui.toolbox.editor.EditorBase", methodName : "init"});
		}
		try {
			this.reset();
		} catch( e ) {
...
silex.ui.toolbox.editor.LinkEditor.prototype = $extend(silex.ui.toolbox.editor.EditorBase.prototype,{
	apply: function() {
		haxe.Log.trace("apply " + Std.string(this.targetElement),{ fileName : "LinkEditor.hx", lineNumber : 107, className : "silex.ui.toolbox.editor.LinkEditor", methodName : "apply"});
		var value = this.inputElement.value;
		if(value != "" && value != null) {
	...
	,load: function(element) {
		haxe.Log.trace("load " + Std.string(this.targetElement),{ fileName : "LinkEditor.hx", lineNumber : 81, className : "silex.ui.toolbox.editor.LinkEditor", methodName : "load"});
		if(!brix.util.DomTools.hasClass(element,"SilexLink") || silex.publication.PublicationModel.getInstance().application == null) this.reset(); else {
			...
			} else if(silex.ui.link.SilexLink.isPage(value,silex.publication.PublicationModel.getInstance().application.id)) this.pageSelectElement.value = value; else this.reset();
		}
	}
	,reset: function() {
		haxe.Log.trace("reset " + Std.string(this.targetElement),{ fileName : "LinkEditor.hx", lineNumber : 71, className : "silex.ui.toolbox.editor.LinkEditor", methodName : "reset"});
		this.inputElement.value = "";
...
silex.ui.dialog.TextEditorDialog.TEXT_EDITOR_HTML_PAGE = "../../third-party-tools/ckeditor/ckeditor.html";
...
silex.ui.toolbox.ToolBoxController.CSS_DESCRIPTOR_FILE_URL = "../admin/css-styles.xml";
