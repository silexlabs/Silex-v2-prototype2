...
class cocktail_core_html_HTMLBRElement extends cocktail_core_html_EmbeddedElement {
	public function __construct() { if(!php_Boot::$skip_constructor) {
		$GLOBALS['%s']->push("cocktail.core.html.HTMLBRElement::new");
		$»spos = $GLOBALS['%s']->length;
		parent::__construct("BR");
		$GLOBALS['%s']->pop();
	}}
	public function isVoidElement() {
		$GLOBALS['%s']->push("cocktail.core.html.HTMLBRElement::isVoidElement");
		$»spos = $GLOBALS['%s']->length;
		{
			$GLOBALS['%s']->pop();
			return true;
	...
	function __toString() { return 'cocktail.core.html.HTMLBRElement'; }
}
