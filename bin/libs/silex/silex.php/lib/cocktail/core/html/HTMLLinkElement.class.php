...
class cocktail_core_html_HTMLLinkElement extends cocktail_core_html_HTMLElement {
	...
	public function get_hreflang() {
		...
		$»spos = $GLOBALS['%s']->length;
		{
			$»tmp = $this->getAttribute("hreflang");
			$GLOBALS['%s']->pop();
			return $»tmp;
		}
		$GLOBALS['%s']->pop();
	...
	public function detach() {
		$GLOBALS['%s']->push("cocktail.core.html.HTMLLinkElement::detach");
		$»spos = $GLOBALS['%s']->length;
		parent::detach();
	...
	public function attach() {
		$GLOBALS['%s']->push("cocktail.core.html.HTMLLinkElement::attach");
		$»spos = $GLOBALS['%s']->length;
