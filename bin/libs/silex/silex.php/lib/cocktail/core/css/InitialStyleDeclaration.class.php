...
class cocktail_core_css_InitialStyleDeclaration extends cocktail_core_css_CSSStyleDeclaration {
	...
	public function get_supportedCSSProperties() {
		$GLOBALS['%s']->push("cocktail.core.css.InitialStyleDeclaration::get_supportedCSSProperties");
		$»spos = $GLOBALS['%s']->length;
		$supportedPropertiesCopy = new Hash();
		if(null == $this->_supportedCSSProperties) throw new HException('null iterable');
		$»it = $this->_supportedCSSProperties->keys();
		while($»it->hasNext()) {
	...
	public function pushProperty($name, $typedValue) {
		...
		$»spos = $GLOBALS['%s']->length;
		$typedProperty = new cocktail_core_css_TypedPropertyVO($name, $typedValue, false);
		$this->_properties->push($typedProperty);
		$this->_propertiesHash->set($name, $typedProperty);
		$GLOBALS['%s']->pop();
	}
	...
	public function initSupportedCSSProperties() {
		...
		$»spos = $GLOBALS['%s']->length;
		$this->_supportedCSSProperties = new Hash();
		$this->_supportedCSSProperties->set("display", null);
		$this->_supportedCSSProperties->set("position", null);
		$this->_supportedCSSProperties->set("float", null);
		$this->_supportedCSSProperties->set("clear", null);
		$this->_supportedCSSProperties->set("z-index", null);
		$this->_supportedCSSProperties->set("overflow-x", null);
		$this->_supportedCSSProperties->set("overflow-y", null);
		$this->_supportedCSSProperties->set("visibility", null);
		$this->_supportedCSSProperties->set("opacity", null);
		$this->_supportedCSSProperties->set("vertical-align", null);
		$this->_supportedCSSProperties->set("line-height", null);
		$this->_supportedCSSProperties->set("width", null);
		$this->_supportedCSSProperties->set("height", null);
		$this->_supportedCSSProperties->set("min-width", null);
		$this->_supportedCSSProperties->set("min-height", null);
		$this->_supportedCSSProperties->set("max-width", null);
		$this->_supportedCSSProperties->set("max-height", null);
		$this->_supportedCSSProperties->set("margin-left", null);
		$this->_supportedCSSProperties->set("margin-top", null);
		$this->_supportedCSSProperties->set("margin-right", null);
		$this->_supportedCSSProperties->set("margin-bottom", null);
		$this->_supportedCSSProperties->set("padding-left", null);
		$this->_supportedCSSProperties->set("padding-top", null);
		$this->_supportedCSSProperties->set("padding-right", null);
		$this->_supportedCSSProperties->set("padding-bottom", null);
		$this->_supportedCSSProperties->set("left", null);
		$this->_supportedCSSProperties->set("right", null);
		$this->_supportedCSSProperties->set("top", null);
		$this->_supportedCSSProperties->set("bottom", null);
		$this->_supportedCSSProperties->set("font-family", null);
		$this->_supportedCSSProperties->set("font-size", null);
		$this->_supportedCSSProperties->set("font-style", null);
		$this->_supportedCSSProperties->set("font-variant", null);
		$this->_supportedCSSProperties->set("font-weight", null);
		$this->_supportedCSSProperties->set("letter-spacing", null);
		$this->_supportedCSSProperties->set("word-spacing", null);
		$this->_supportedCSSProperties->set("text-indent", null);
		$this->_supportedCSSProperties->set("text-align", null);
		$this->_supportedCSSProperties->set("white-space", null);
		$this->_supportedCSSProperties->set("text-transform", null);
		$this->_supportedCSSProperties->set("color", null);
		$this->_supportedCSSProperties->set("transition-property", null);
		$this->_supportedCSSProperties->set("transition-duration", null);
		$this->_supportedCSSProperties->set("transition-delay", null);
		$this->_supportedCSSProperties->set("transition-timing-function", null);
		$this->_supportedCSSProperties->set("transform", null);
		$this->_supportedCSSProperties->set("transform-origin", null);
		$this->_supportedCSSProperties->set("background-color", null);
		$this->_supportedCSSProperties->set("background-image", null);
		$this->_supportedCSSProperties->set("background-position", null);
		$this->_supportedCSSProperties->set("background-size", null);
		$this->_supportedCSSProperties->set("background-repeat", null);
		$this->_supportedCSSProperties->set("background-origin", null);
		$this->_supportedCSSProperties->set("background-clip", null);
		$this->_supportedCSSProperties->set("cursor", null);
		$GLOBALS['%s']->pop();
	}
	...
	public $_supportedCSSProperties;
