...
class cocktail_core_style_computer_boxComputers_EmbeddedPositionedBoxStylesComputer extends cocktail_core_style_computer_boxComputers_EmbeddedBlockBoxStylesComputer {
	public function __construct() { if(!php_Boot::$skip_constructor) {
		$GLOBALS['%s']->push("cocktail.core.style.computer.boxComputers.EmbeddedPositionedBoxStylesComputer::new");
		$製pos = $GLOBALS['%s']->length;
		parent::__construct();
		$GLOBALS['%s']->pop();
	}}
	public function getComputedStaticTop($style, $containingBlockData) {
		$GLOBALS['%s']->push("cocktail.core.style.computer.boxComputers.EmbeddedPositionedBoxStylesComputer::getComputedStaticTop");
		$製pos = $GLOBALS['%s']->length;
		{
	...
	public function getComputedStaticLeft($style, $containingBlockData) {
		$GLOBALS['%s']->push("cocktail.core.style.computer.boxComputers.EmbeddedPositionedBoxStylesComputer::getComputedStaticLeft");
		$製pos = $GLOBALS['%s']->length;
		{
	...
	public function measureVerticalPositionOffsets($style, $containingBlockData, $fontMetrics) {
		$GLOBALS['%s']->push("cocktail.core.style.computer.boxComputers.EmbeddedPositionedBoxStylesComputer::measureVerticalPositionOffsets");
		$製pos = $GLOBALS['%s']->length;
	...
	public function measureHorizontalPositionOffsets($style, $containingBlockData, $fontMetrics) {
		$GLOBALS['%s']->push("cocktail.core.style.computer.boxComputers.EmbeddedPositionedBoxStylesComputer::measureHorizontalPositionOffsets");
		$製pos = $GLOBALS['%s']->length;
		$computedStyle = $style->computedStyle;
	...
	public function measurePositionOffsets($style, $containingBlockData, $fontMetrics) {
		$GLOBALS['%s']->push("cocktail.core.style.computer.boxComputers.EmbeddedPositionedBoxStylesComputer::measurePositionOffsets");
		$製pos = $GLOBALS['%s']->length;
