...
class cocktail_core_style_formatter_FormattingContext {
	public function __construct($formattingContextRoot) {
		...
		$GLOBALS['%s']->push("cocktail.core.style.formatter.FormattingContext::new");
	...
	public function applyShrinkToFitIfNeeded($elementRenderer, $minimumWidth) {
		$GLOBALS['%s']->push("cocktail.core.style.formatter.FormattingContext::applyShrinkToFitIfNeeded");
		$»spos = $GLOBALS['%s']->length;
	...
	public function startFormatting() {
		$GLOBALS['%s']->push("cocktail.core.style.formatter.FormattingContext::startFormatting");
		$»spos = $GLOBALS['%s']->length;
		$GLOBALS['%s']->pop();
	}
	public function format($floatsManager) {
		$GLOBALS['%s']->push("cocktail.core.style.formatter.FormattingContext::format");
		$»spos = $GLOBALS['%s']->length;
	...
	public function initFormattingContextData() {
		$GLOBALS['%s']->push("cocktail.core.style.formatter.FormattingContext::initFormattingContextData");
		$»spos = $GLOBALS['%s']->length;
