...
class cocktail_core_dom_Comment extends cocktail_core_dom_CharacterData {
	public function __construct() { if(!php_Boot::$skip_constructor) {
		$GLOBALS['%s']->push("cocktail.core.dom.Comment::new");
		$製pos = $GLOBALS['%s']->length;
		parent::__construct();
		$GLOBALS['%s']->pop();
	}}
	public function get_nodeType() {
		$GLOBALS['%s']->push("cocktail.core.dom.Comment::get_nodeType");
		$製pos = $GLOBALS['%s']->length;
		{
			$GLOBALS['%s']->pop();
			return 8;
	...
	public function detach($recursive) {
		$GLOBALS['%s']->push("cocktail.core.dom.Comment::detach");
		$製pos = $GLOBALS['%s']->length;
		$GLOBALS['%s']->pop();
	}
	public function attach($recursive) {
		$GLOBALS['%s']->push("cocktail.core.dom.Comment::attach");
		$製pos = $GLOBALS['%s']->length;
		$GLOBALS['%s']->pop();
	}
	public function updateElementRenderer() {
		$GLOBALS['%s']->push("cocktail.core.dom.Comment::updateElementRenderer");
		$製pos = $GLOBALS['%s']->length;
		$GLOBALS['%s']->pop();
	}
	...
	function __toString() { return 'cocktail.core.dom.Comment'; }
}
