...
class cocktail_core_dom_Text extends cocktail_core_dom_CharacterData {
	public function __construct() { if(!php_Boot::$skip_constructor) {
		$GLOBALS['%s']->push("cocktail.core.dom.Text::new");
		$製pos = $GLOBALS['%s']->length;
		parent::__construct();
		$GLOBALS['%s']->pop();
	}}
	public function get_nodeType() {
		$GLOBALS['%s']->push("cocktail.core.dom.Text::get_nodeType");
		$製pos = $GLOBALS['%s']->length;
		{
			$GLOBALS['%s']->pop();
			return 3;
	...
	public function get_nodeName() {
		$GLOBALS['%s']->push("cocktail.core.dom.Text::get_nodeName");
		$製pos = $GLOBALS['%s']->length;
		{
			$GLOBALS['%s']->pop();
			return "#text";
	...
	public function isRendered() {
		$GLOBALS['%s']->push("cocktail.core.dom.Text::isRendered");
		$製pos = $GLOBALS['%s']->length;
		{
			$GLOBALS['%s']->pop();
			return true;
	...
	public function attachCoreStyle() {
		$GLOBALS['%s']->push("cocktail.core.dom.Text::attachCoreStyle");
		$製pos = $GLOBALS['%s']->length;
		$this->elementRenderer->coreStyle = $this->parentNode->coreStyle;
		$GLOBALS['%s']->pop();
	}
	public function createElementRenderer() {
		$GLOBALS['%s']->push("cocktail.core.dom.Text::createElementRenderer");
		$製pos = $GLOBALS['%s']->length;
		$this->elementRenderer = new cocktail_core_renderer_TextRenderer($this);
		$GLOBALS['%s']->pop();
	}
	...
	function __toString() { return 'cocktail.core.dom.Text'; }
}
