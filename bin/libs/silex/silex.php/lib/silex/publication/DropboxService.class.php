...
class silex_publication_DropboxService extends silex_ServiceBase {
	public function __construct() { if(!php_Boot::$skip_constructor) {
		$GLOBALS['%s']->push("silex.publication.DropboxService::new");
		$»spos = $GLOBALS['%s']->length;
		parent::__construct(silex_publication_DropboxService::$SERVICE_NAME);
		$GLOBALS['%s']->pop();
	}}
	public function setPublicationConfig($publicationName, $configData) {
		$GLOBALS['%s']->push("silex.publication.DropboxService::setPublicationConfig");
		$»spos = $GLOBALS['%s']->length;
		try {
	...
	public function getPublicationConfig($publicationName) {
		$GLOBALS['%s']->push("silex.publication.DropboxService::getPublicationConfig");
		$»spos = $GLOBALS['%s']->length;
		try {
	...
	public function setPublicationData($publicationName, $publicationData) {
		$GLOBALS['%s']->push("silex.publication.DropboxService::setPublicationData");
		$»spos = $GLOBALS['%s']->length;
		try {
	...
	public function getPublicationData($publicationName) {
		$GLOBALS['%s']->push("silex.publication.DropboxService::getPublicationData");
		$»spos = $GLOBALS['%s']->length;
		try {
	...
	public function trash($publicationName) {
		$GLOBALS['%s']->push("silex.publication.DropboxService::trash");
		$»spos = $GLOBALS['%s']->length;
		try {
	...
	public function rename($srcPublicationName, $publicationName) {
		$GLOBALS['%s']->push("silex.publication.DropboxService::rename");
		$»spos = $GLOBALS['%s']->length;
		try {
	...
	public function duplicate($srcPublicationName, $publicationName) {
		$GLOBALS['%s']->push("silex.publication.DropboxService::duplicate");
		$»spos = $GLOBALS['%s']->length;
		try {
			$this->doDuplicate($srcPublicationName, $publicationName, null);
		}catch(Exception $»e) {
	...
	public function create($publicationName) {
		$GLOBALS['%s']->push("silex.publication.DropboxService::create");
		$»spos = $GLOBALS['%s']->length;
		try {
	...
	public function emptyTrash() {
		$GLOBALS['%s']->push("silex.publication.DropboxService::emptyTrash");
		$»spos = $GLOBALS['%s']->length;
	...
	public function getPublications($stateFilter = null, $categoryFilter = null) {
		$GLOBALS['%s']->push("silex.publication.DropboxService::getPublications");
		$»spos = $GLOBALS['%s']->length;
	...
	public function doDuplicate($srcPublicationName, $publicationName, $newConfigData = null) {
		$GLOBALS['%s']->push("silex.publication.DropboxService::doDuplicate");
		$»spos = $GLOBALS['%s']->length;
		try {
	...
	public function getPublicationFolder($publicationName) {
		$GLOBALS['%s']->push("silex.publication.DropboxService::getPublicationFolder");
		$»spos = $GLOBALS['%s']->length;
		{
	...
	function __toString() { return 'silex.publication.DropboxService'; }
}
