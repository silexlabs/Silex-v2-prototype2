...
class silex_file_kcfinder_FileService extends silex_ServiceBase {
	public function __construct($serverConfig) {
		if(!php_Boot::$skip_constructor) {
		$GLOBALS['%s']->push("silex.file.kcfinder.FileService::new");
		$»spos = $GLOBALS['%s']->length;
		parent::__construct(silex_file_kcfinder_FileService::$SERVICE_NAME);
		$this->serverConfig = $serverConfig;
		$GLOBALS['%s']->pop();
	}}
	public function save($name, $content) {
		$GLOBALS['%s']->push("silex.file.kcfinder.FileService::save");
		$»spos = $GLOBALS['%s']->length;
		try {
	...
	public function trash($name) {
		$GLOBALS['%s']->push("silex.file.kcfinder.FileService::trash");
		$»spos = $GLOBALS['%s']->length;
		try {
	...
	public function rename($src, $dst) {
		$GLOBALS['%s']->push("silex.file.kcfinder.FileService::rename");
		$»spos = $GLOBALS['%s']->length;
		try {
	...
	public function duplicate($src, $dst) {
		$GLOBALS['%s']->push("silex.file.kcfinder.FileService::duplicate");
		$»spos = $GLOBALS['%s']->length;
		try {
	...
	public function load($name) {
		$GLOBALS['%s']->push("silex.file.kcfinder.FileService::load");
		$»spos = $GLOBALS['%s']->length;
		$content = "";
		try {
	...
	public function checkInstall() {
		$GLOBALS['%s']->push("silex.file.kcfinder.FileService::checkInstall");
		$»spos = $GLOBALS['%s']->length;
		{
			$»tmp = _hx_anonymous(array("version" => "2.0", "latest_version" => "2.0", "redirect" => null));
			$GLOBALS['%s']->pop();
			return $»tmp;
		}
		$GLOBALS['%s']->pop();
	...
	function __toString() { return 'silex.file.kcfinder.FileService'; }
}
