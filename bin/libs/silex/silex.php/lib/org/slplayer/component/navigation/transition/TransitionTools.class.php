...
class org_slplayer_component_navigation_transition_TransitionTools {
	...
	static function getTransitionData($rootElement, $type) {
		$GLOBALS['%s']->push("org.slplayer.component.navigation.transition.TransitionTools::getTransitionData");
	...
	static function setTransitionProperty($rootElement, $name, $value) {
		$GLOBALS['%s']->push("org.slplayer.component.navigation.transition.TransitionTools::setTransitionProperty");
		$»spos = $GLOBALS['%s']->length;
