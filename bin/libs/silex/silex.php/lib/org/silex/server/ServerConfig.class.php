...
class org_silex_server_ServerConfig extends org_silex_ConfigBase {
	public function __construct($configFile = null) {
		if(!php_Boot::$skip_constructor) {
		$GLOBALS['%s']->push("org.silex.server.ServerConfig::new");
	...
	public function confDataToXml($xml) {
		$GLOBALS['%s']->push("org.silex.server.ServerConfig::confDataToXml");
		$»spos = $GLOBALS['%s']->length;
	...
	public function xmlToConfData($xml) {
		$GLOBALS['%s']->push("org.silex.server.ServerConfig::xmlToConfData");
		$»spos = $GLOBALS['%s']->length;
	...
	function __toString() { return 'org.silex.server.ServerConfig'; }
}
