...
class org_silex_ConfigBase {
	...
	public function saveData($configFile) {
		$GLOBALS['%s']->push("org.silex.ConfigBase::saveData");
		$製pos = $GLOBALS['%s']->length;
	...
	public function loadData($configFile) {
		$GLOBALS['%s']->push("org.silex.ConfigBase::loadData");
		$製pos = $GLOBALS['%s']->length;
	...
	public function confDataToXml($xml) {
		$GLOBALS['%s']->push("org.silex.ConfigBase::confDataToXml");
		$製pos = $GLOBALS['%s']->length;
	...
	public function xmlToConfData($xml) {
		$GLOBALS['%s']->push("org.silex.ConfigBase::xmlToConfData");
		$製pos = $GLOBALS['%s']->length;
		throw new HException("This virtual method has to be implemented in the derived class");
		$GLOBALS['%s']->pop();
	}
	...
	function __toString() { return 'org.silex.ConfigBase'; }
}
