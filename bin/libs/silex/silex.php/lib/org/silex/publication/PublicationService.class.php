...
class org_silex_publication_PublicationService extends org_silex_ServiceBase {
	public function __construct() { if(!php_Boot::$skip_constructor) {
		$GLOBALS['%s']->push("org.silex.publication.PublicationService::new");
	...
	public function setPublicationConfig($publicationName, $configData, $publicationFolder = null) {
		$GLOBALS['%s']->push("org.silex.publication.PublicationService::setPublicationConfig");
		$»spos = $GLOBALS['%s']->length;
	...
	public function getPublicationConfig($publicationName, $publicationFolder = null) {
		$GLOBALS['%s']->push("org.silex.publication.PublicationService::getPublicationConfig");
		$»spos = $GLOBALS['%s']->length;
		if($publicationFolder === null) {
			$publicationFolder = "publications/";
		}
	...
	public function setPublicationData($publicationName, $publicationData, $publicationFolder = null) {
		$GLOBALS['%s']->push("org.silex.publication.PublicationService::setPublicationData");
		$»spos = $GLOBALS['%s']->length;
		if($publicationFolder === null) {
			$publicationFolder = "publications/";
		}
	...
	public function getPublicationData($publicationName, $publicationFolder = null) {
		$GLOBALS['%s']->push("org.silex.publication.PublicationService::getPublicationData");
		$»spos = $GLOBALS['%s']->length;
		if($publicationFolder === null) {
			$publicationFolder = "publications/";
		}
	...
	public function trash($publicationName, $publicationFolder = null) {
		$GLOBALS['%s']->push("org.silex.publication.PublicationService::trash");
		$»spos = $GLOBALS['%s']->length;
		if($publicationFolder === null) {
			$publicationFolder = "publications/";
		}
	...
	public function rename($srcPublicationName, $publicationName, $publicationFolder = null) {
		$GLOBALS['%s']->push("org.silex.publication.PublicationService::rename");
		$»spos = $GLOBALS['%s']->length;
		if($publicationFolder === null) {
			$publicationFolder = "publications/";
		}
	...
	public function duplicate($srcPublicationName, $publicationName, $publicationFolder = null) {
		$GLOBALS['%s']->push("org.silex.publication.PublicationService::duplicate");
		$»spos = $GLOBALS['%s']->length;
		if($publicationFolder === null) {
			$publicationFolder = "publications/";
		}
	...
	public function create($publicationName, $publicationData, $publicationFolder = null) {
		$GLOBALS['%s']->push("org.silex.publication.PublicationService::create");
		$»spos = $GLOBALS['%s']->length;
		if($publicationFolder === null) {
			$publicationFolder = "publications/";
		}
	...
	public function emptyTrash($publicationFolder = null) {
		$GLOBALS['%s']->push("org.silex.publication.PublicationService::emptyTrash");
		$»spos = $GLOBALS['%s']->length;
		if($publicationFolder === null) {
			$publicationFolder = "publications/";
		}
	...
	public function getPublications($stateFilter = null, $categoryFilter = null, $publicationFolder = null) {
		$GLOBALS['%s']->push("org.silex.publication.PublicationService::getPublications");
		$»spos = $GLOBALS['%s']->length;
		if($publicationFolder === null) {
			$publicationFolder = "publications/";
		}
