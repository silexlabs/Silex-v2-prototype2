...
class org_silex_publication_PublicationConfig extends org_silex_ConfigBase {
	public function __construct($configFile = null) {
		if(!php_Boot::$skip_constructor) {
		$GLOBALS['%s']->push("org.silex.publication.PublicationConfig::new");
	...
	public function confDataToXml($xml) {
		$GLOBALS['%s']->push("org.silex.publication.PublicationConfig::confDataToXml");
		$»spos = $GLOBALS['%s']->length;
	...
	public function getChangeDataFromXML($xml) {
		$GLOBALS['%s']->push("org.silex.publication.PublicationConfig::getChangeDataFromXML");
		$»spos = $GLOBALS['%s']->length;
		$author = "";
	...
	public function xmlToConfData($xml) {
		$GLOBALS['%s']->push("org.silex.publication.PublicationConfig::xmlToConfData");
		$»spos = $GLOBALS['%s']->length;
