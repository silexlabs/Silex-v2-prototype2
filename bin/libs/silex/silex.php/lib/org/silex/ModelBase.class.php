...
class org_silex_ModelBase {
	...
	public function createEvent($eventName, $detail = null) {
		$GLOBALS['%s']->push("org.silex.ModelBase::createEvent");
		$»spos = $GLOBALS['%s']->length;
	...
	public function dispatchEvent($event) {
		$GLOBALS['%s']->push("org.silex.ModelBase::dispatchEvent");
		$»spos = $GLOBALS['%s']->length;
	...
	public function removeEventListener($eventName, $callbackFunction) {
		$GLOBALS['%s']->push("org.silex.ModelBase::removeEventListener");
		$»spos = $GLOBALS['%s']->length;
	...
	public function addEventListener($eventName, $callbackFunction) {
		$GLOBALS['%s']->push("org.silex.ModelBase::addEventListener");
		$»spos = $GLOBALS['%s']->length;
	...
	public function isSameEventListeners($el1, $el2) {
		$GLOBALS['%s']->push("org.silex.ModelBase::isSameEventListeners");
		$»spos = $GLOBALS['%s']->length;
		{
	...
	public function getEventListener($callbackFunction, $eventName) {
		$GLOBALS['%s']->push("org.silex.ModelBase::getEventListener");
		$»spos = $GLOBALS['%s']->length;
		if(null == $this->listeners) throw new HException('null iterable');
		$»it = $this->listeners->iterator();
		while($»it->hasNext()) {
	...
	public function setSelectedItem($item) {
		$GLOBALS['%s']->push("org.silex.ModelBase::setSelectedItem");
		$»spos = $GLOBALS['%s']->length;
	...
	public function setHoveredItem($item) {
		$GLOBALS['%s']->push("org.silex.ModelBase::setHoveredItem");
		$»spos = $GLOBALS['%s']->length;
	...
	function __toString() { return 'org.silex.ModelBase'; }
}
