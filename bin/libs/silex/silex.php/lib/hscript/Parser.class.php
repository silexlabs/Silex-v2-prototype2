...
class hscript_Parser {
	...
	public function makeBinop($op, $e1, $e) {
		...
		$퍀pos = $GLOBALS['%s']->length;
		{
			$퍁mp = hscript_Parser_7($this, $e, $e1, $op);
			$GLOBALS['%s']->pop();
			return $퍁mp;
		}
		$GLOBALS['%s']->pop();
	...
	public function makeUnop($op, $e) {
		...
		$퍀pos = $GLOBALS['%s']->length;
		{
			$퍁mp = hscript_Parser_8($this, $e, $op);
			$GLOBALS['%s']->pop();
			return $퍁mp;
		}
		$GLOBALS['%s']->pop();
	...
	public function parse($s) {
		...
		{
			$퍁mp = hscript_Parser_10($this, $a, $s);
			$GLOBALS['%s']->pop();
			return $퍁mp;
		}
		$GLOBALS['%s']->pop();
