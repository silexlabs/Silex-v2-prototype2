...
class Xml {
	...
	public function elementsNamed($name) {
		...
		{
			$»tmp = Lambda::filter($this->_children, array(new _hx_lambda(array(&$name), "Xml_0"), 'execute'))->iterator();
			$GLOBALS['%s']->pop();
			return $»tmp;
		}
		$GLOBALS['%s']->pop();
	...
	public function elements() {
		...
		{
			$»tmp = Lambda::filter($this->_children, array(new _hx_lambda(array(), "Xml_1"), 'execute'))->iterator();
			$GLOBALS['%s']->pop();
			return $»tmp;
		}
		$GLOBALS['%s']->pop();
...
function Xml_0(&$name, $child) {
	$»spos = $GLOBALS['%s']->length;
	{
		$GLOBALS['%s']->push("Xml::elementsNamed@260");
		$»spos2 = $GLOBALS['%s']->length;
		{
			$»tmp = $child->nodeType == Xml::$Element && $child->getNodeName() === $name;
			$GLOBALS['%s']->pop();
			return $»tmp;
		}
		$GLOBALS['%s']->pop();
...
function Xml_1($child) {
	$»spos = $GLOBALS['%s']->length;
	{
		$GLOBALS['%s']->push("Xml::elements@255");
		$»spos2 = $GLOBALS['%s']->length;
		{
			$»tmp = $child->nodeType == Xml::$Element;
			$GLOBALS['%s']->pop();
			return $»tmp;
		}
		$GLOBALS['%s']->pop();
