...
class haxe_FastList {
	...
	public function iterator() {
		...
		$l = $this->head;
		{
			$»tmp = _hx_anonymous(array("hasNext" => array(new _hx_lambda(array(&$l), "haxe_FastList_0"), 'execute'), "next" => array(new _hx_lambda(array(&$l), "haxe_FastList_1"), 'execute')));
			$GLOBALS['%s']->pop();
			return $»tmp;
		}
		$GLOBALS['%s']->pop();
...
function haxe_FastList_0(&$l) {
	$»spos = $GLOBALS['%s']->length;
	{
		$GLOBALS['%s']->push("haxe.FastList::iterator@141");
...
function haxe_FastList_1(&$l) {
	$»spos = $GLOBALS['%s']->length;
	{
		$GLOBALS['%s']->push("haxe.FastList::iterator@144");
		$»spos2 = $GLOBALS['%s']->length;
		$k = $l;
		$l = $k->next;
		{
