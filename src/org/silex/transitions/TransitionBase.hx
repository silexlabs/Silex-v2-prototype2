...
class TransitionBase extends DisplayObject{
	 ...
	 * Dispatch a transitionEventTypeStarted to notify the Layter class
	...
	private function onTransitionEventTypeRequest(event:Event){
		...
		var transitionData:TransitionData = untyped event.data;
	 ...
	 */
	private function applyTransitionParams(
